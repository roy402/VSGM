...
class Global_Policy(torch.nn.Module):

    def __init__(self, input_shape, out_shape=256, hidden_size=512, downscaling=1):
        super().__init__()
        ...
        self.linear1 = nn.Linear(out_size * 32 * 4, hidden_size)
        # self.linear1 = nn.Linear(out_size * 32 + 8, hidden_size)
        self.linear2 = nn.Linear(hidden_size, out_shape)
